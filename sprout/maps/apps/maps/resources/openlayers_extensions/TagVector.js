...
/**
 * Class: Maps.TagVector
 * A stripped down version of vector.
 * Instances of Maps.TagVector are used to fast render tag point data.
 * It does not require features to be have style and implement the Feature class.
 *
 *     <Maps.TagVector> constructor.
 *
 * Inherits from:
 *  - <OpenLayers.Layer>
 */
Maps.TagVector = OpenLayers.Class(OpenLayers.Layer, {
     ...
     * Each feature can be a simple object. The only requirement is to have x,y attributes (in 900913 coords).
     ...
     * Fast-Remove all features from the layer. Only trigger before/featuresremoved
     * global events.
     *
     * Parameters:
     * options - {Object} Optional properties for changing behavior of the
